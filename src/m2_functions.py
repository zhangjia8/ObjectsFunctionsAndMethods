...
def turtle4():
    ...
    will.pen = rg.Pen('grey', 10)
    will.paint_bucket = rg.PaintBucket('black')

    here = rg.Point(random.randrange(-500,500),
...
def turtle5():
    ...
    sam.paint_bucket = rg.PaintBucket('green')
    sam.forward(500)
    sam.begin_fill()
    sam.draw_circle(20)
    sam.end_fill()

    amy = rg.SimpleTurtle('square')
    amy.pen = rg.Pen('orange',6)
    amy.paint_bucket = rg.PaintBucket('yellow')
    amy.backward(500)
    amy.begin_fill()
    amy.draw_circle(20)
    amy.end_fill()
