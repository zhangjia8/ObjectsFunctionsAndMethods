...
def try_methods_and_functions():
    ...
    """
    amy = rg.SimpleTurtle()
    amy.pen = rg.Pen('blue', 5)

    amy.backward(150)
    amy.speed = 1
    draw_many_squares(amy, 2, 100, 30)

    amy.pen = rg.Pen('red', 5)
    amy.speed = 5
    draw_many_squares(amy, 10, 50, 15)

    amy.speed = 100
    amy.pen = rg.Pen('red', 35)
    draw_many_squares(amy, 8, 300, 60)

    amy.pen = rg.Pen('black',3)
    amy.backward(200)
    amy.draw_circle(30)
    amy.draw_square(50)
